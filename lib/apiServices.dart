...
List<Use> useFromJson(String str) => List<Use>.from(json.decode(str).map((x) => Use.fromJson(x)));

String useToJson(List<Use> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
